Ext.define('AppName.view.categorias.GridListaSubcategorias',{
				...
				},
				{
			        ...
			        handler: function(){
			        	...
			        	if(model[0] != null){
				        	...
				        	proxy._api.read = 'app/data/php/Categorias.php?action=listSubcategorias&id_categorias=' + model[0].data.id_categorias
	...
	listeners: {
		...
		// 		proxy._api.read = "app/data/php/Categorias.php?action=getCategorias&nomeCategoria="+nome_categoria
