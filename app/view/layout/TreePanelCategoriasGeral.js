       ...
       },
       {
           ...
           handler:function(){
            ...
            if(pesquisa != ''){
                    ...
                    store._api.read = 'app/data/php/Produtos.php?action=searchProduto&nome_produto=' + pesquisa
    ...
    bbar:[
        {
            ...
            handler: function(){
                ...
                proxy._api.read = 'app/data/php/Categorias.php?action=getCategorias&default='+1;
...

        {
            ...
            handler: function(){
                // Ext.getCmp('treeCategoriasGeral').store.removeAll();
                var proxy = Ext.getCmp('treeCategoriasGeral').store.getProxy();
                proxy._api.read = 'app/data/php/Categorias.php?action=getCategorias&default='+0;
                Ext.getCmp('treeCategoriasGeral').store.setProxy(proxy);
                Ext.getCmp('treeCategoriasGeral').store.load();
