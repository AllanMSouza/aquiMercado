...
itemclick: function(a, b) {
          ...
          if(nomeCategoria == 'Ofertas'){
            ...
            store._api.read = 'app/data/php/Ofertas.php?action=selectOfertaMercado'
            ...
            if(nomeCategoria == 'Kits'){
                store._url = 'app/data/php/Kits.php?action=selectKitsCliente';
            }
            else{
                store._url = 'app/data/php/Categorias.php?action=getCategorias&nomeCategoria=' + nomeCategoria;
            }
