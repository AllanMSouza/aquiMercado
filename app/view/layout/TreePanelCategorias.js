    ...
    bbar:[
        {
            ...
            handler: function(){
                ...
                proxy._api.read = 'app/data/php/Categorias.php?action=getCategoriasPadrao'
                Ext.getCmp('dataViewNewHeaderPanelCliente').store.setProxy(proxy)

                // var proxy2 = Ext.getCmp('panel-categorias').store.getProxy()
                // proxy2._api.read = 'app/data/php/Categorias.php?action=getCategorias'
...

        {
            ...
            handler: function(){
                var proxy = Ext.getCmp('dataViewNewHeaderPanelCliente').store.getProxy()
                proxy._api.read = 'app/data/php/Categorias.php?action=getCategoriasMercado'
                Ext.getCmp('dataViewNewHeaderPanelCliente').store.setProxy(proxy)
