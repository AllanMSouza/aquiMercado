...
//                console.log(model[0])
                if(model[0].data.kit){
                    ...
                    if(Ext.getCmp('janelaAberta') == null){
                        ...
                        // console.log(store._api)
                        store._api.read = 'app/data/php/Produtos.php?action=getProdutosMercadoDefault&id_categorias=' + model[0].data.id_categorias + '&leaf=' + model[0].data.leaf
                        store2._api.read = 'app/data/php/Produtos.php?action=getProdutosMercadoDefault&id_categorias=' + model[0].data.id_categorias + '&leaf=' + model[0].data.leaf
...
//            console.log(Ext.getCmp('dataViewListaProdutosMercado').store)
             if(!Ext.getCmp('idImageView')){
                   ...
                   proxy._api.read = 'app/data/php/Produtos.php?action=getProdutosMercado&id_categorias=' + model.data.id_categorias + '&leaf=' + model.data.leaf
                ...
                store._api.read = 'app/data/php/Produtos.php?action=getProdutos&id_categorias=' + model.data.id_categorias + '&leaf=' + model.data.leaf
                ...
                store._api.read = 'app/data/php/Produtos.php?action=getProdutosMercado&id_categorias=' + model.data.id_categorias + '&leaf=' + model.data.leaf
